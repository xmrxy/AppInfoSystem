                    ...
                    <ul>
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="queryStatus" name="valueNameStatus" class="form-control">
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="queryFlatformId" name="valueNamePingTai" class="form-control">
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="queryCategoryLevel1" name="categoryName1" class="form-control">
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <select name="categoryName2" id="queryCategoryLevel2" class="form-control">
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="categoryName3" id="queryCategoryLevel3" class="form-control">
        ...
        <div class="x_panel">
            <div class="x_content">
                ...
                <div id="datatable-responsive_wrapper"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <a href="${pageContext.request.contextPath}/dev/appAdd.html"
                            ...
                            <table id="datatable-responsive"
                                ...
                                <c:forEach var="appInfo" items="${appPageBean.list }" varStatus="status">
                                    <tr role="row" class="odd">
                                        ...
                                        <td>${appInfo.categoryName1 } -> ${appInfo.categoryName2 }
                                            -> ${appInfo.categoryName3 }</td>
                                        <td><span id="appInfoStatus${appInfo.id}">${appInfo.valueNameStatus }</span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>
                                                        <c:choose>
                                                            <c:when test="${appInfo.statusId == 2 || appInfo.statusId == 5}">
                                                            ...
                                                            <c:when test="${appInfo.statusId == 4}">
                                                    ...
                                                    <li><a class="modifyAppInfo"
                                                           appinfoid="${appInfo.id }" status="${appInfo.statusId }"
                                                           statusname="${appInfo.valueNameStatus }"
                                                           data-toggle="tooltip" data-placement="top" title=""
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="dataTables_info" id="datatable-responsive_info"
                                ...
                                ${appPageBean.pageIndex }/${appPageBean.totalPage }页
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="dataTables_paginate paging_simple_numbers"
                                ...
                                <ul class="pagination">
                                    ...
                                    <c:if test="${appPageBean.pageIndex < appPageBean.totalCount }">
                                        <li class="paginate_button "><a
                                                href="javascript:page_nav(document.forms[0],${appPageBean.pageIndex+1 });"
                                                aria-controls="datatable-responsive" data-dt-idx="1"
                                                tabindex="0">下一页</a>
                                        ...
                                        <li class="paginate_button next"><a
                                                href="javascript:page_nav(document.forms[0],${appPageBean.totalPage });"
