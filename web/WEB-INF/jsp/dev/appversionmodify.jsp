        ...
        <form class="form-horizontal form-label-left" action="/appVersion/doUpdateAppSersion.html" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" value="${oneAppVersion.versionNo }"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="versionSize" name="versionSize" value="${oneAppVersion.versionSize }"  required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              ${oneAppVersion.versionInfo }</textarea>
            </div>
          </div>
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="hidden" id="downloadLink" name="downloadLink" value="${oneAppVersion.downloadLink}"/>
            <input type="hidden" id="apkLocPath" name="apkLocPath" value="${oneAppVersion.apkLocPath}"/>
            <input type="hidden" id="apkFileName" name="apkFileName" value="${oneAppVersion.apkFileName}"/>
